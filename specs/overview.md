...
- the built-in web UI can load the configured repo catalog, stage temporary browser-uploaded reference files, and present repo selection through a searchable picker instead of raw comma-separated input
