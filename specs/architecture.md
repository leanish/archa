...
- `src/setup/discovery-progress.js`
...
- `src/setup/discovery-selection.js`
...
- Top-level modules such as `src/config.js`, `src/cli-bootstrap.js`, and `src/github-catalog.js` remain as thin compatibility re-exports so the rest of the codebase and tests do not need a broad path migration.
